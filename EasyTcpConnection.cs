...
public class EasyTcpConnection : IConnection
{
	...
	public EasyTcpConnection(string host, int port, Encoding encoding, UsernamePasswordAuthentication authentication, bool autoReconnect = true, int connectRetryTimeoutMs = 4_000, int connectRetryIntervalMs = 1_000)
	{
